                ...
                <ul>
                    ...
                    <li>
                        <div class="btn_content cl">
                            ...
                            <router-link to="/publishNewProject/step2"><div id="pre">上一步</div></router-link>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    export default {
        ...
        methods: {
            ...
            publish () {
                ...
                const httpName = "发布新项目"
                this.$http.post('/regular_project', ajaxData)
                        .then((response) => {
