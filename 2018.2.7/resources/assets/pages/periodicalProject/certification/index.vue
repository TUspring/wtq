            ...
            <Modal v-model="iviewModal" class-name="ivu-modal-custom ivu-modal-middle" :mask-closable="false">
                ...
                <div class="success_content" v-show="success_content">
                    ...
                    <div class="success_middle">
                        <p>恭喜，您的个人身份验证成功！</p>
                        <span v-model="delay">{{delay}}秒后即将自动前往个人中心</span>
                    </div>
                    <div class="button" @click="go">确定</div>
                </div>
                ...
                <ul>
                    ...
                    <li>
                        <div class="ID_input_content cl">
                            <span>身份证号码</span>
                            <input type="text" placeholder="请输入身份证号码" name="身份证号码" v-model="form.ID_number" v-validate data-vv-rules="required">
                        </div>
