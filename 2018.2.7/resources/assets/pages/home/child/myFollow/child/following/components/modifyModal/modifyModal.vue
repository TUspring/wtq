...
export default{
    ...
    beforeMount() {
        ...
        this.followingMsg.id = this.modalDataList.id
        this.followingMsg.follow_lot_ratio =this.modalDataList.follow_lot.follow_lot_ratio
        this.followingMsg.follow_form=this.modalDataList.follow_form
    ...
    methods: {
        ...
        modify () {
            ...
            if (this.followingMsg.follow_lot_ratio!= ''&& this.followingMsg.follow_lot_ratio <  1) {
