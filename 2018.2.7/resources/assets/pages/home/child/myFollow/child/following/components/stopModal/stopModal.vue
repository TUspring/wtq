<style lang="css" scoped src="./css/stopModal.css">
...
<template>
    <div class="stopModal cl">
        ...
        <div class="stop">
            ...
            <!--暂停成功按钮-->
            <div class="successBtn" v-show="show_successBtn" @click="stopSuccess">已暂停成功</div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            stop() {
                ...
                const httpName = "暂停跟随"
                this.$http.put('/policyFollowing/operation',ajaxData,{timeout:30000})
                    .then((response) => {
