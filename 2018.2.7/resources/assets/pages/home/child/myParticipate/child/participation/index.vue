                 ...
                 <ul class="list-ul cl">
                     <li class="list-li" v-for="item in listModel">
                         ...
                         <div class="top-box">
                             <div class="top-left-content cl">
                                 ...
                                 <div class="tx-box">
                                     ...
                                     <p>项目封闭期：{{item.regular_project.start_time | timeStamp}} 至 {{item.regular_project.period | endTime(item.regular_project.start_time)}}</p>
                         ...
                         <div class="stop-box" v-if="item.suspend_time>0">
                             <!--<p>暂停原因：{{item.relations.refused}}</p>-->
                         </div>
                     </li>
                </ul>
            </div>
