            ...
            <Form ref="formInline" :model="formInline" :rules="ruleInline">
                ...
                <!--<FormItem style="margin-bottom:0">-->
                    <!--<Upload-->
                        ...
                        <!--</div>-->
                    <!--</Upload>-->
                    <!--<div style="height: 131px;border: 1px dashed #dddee1;border-radius: 4px;">-->
                        <!--<v-TableSpin style="margin-top:20px"><div slot="text">上传中...</div></v-TableSpin>-->
                    <!--</div>-->
        ...
        methods: {
            ...
            backstageLogin(){
                ...
                return new Promise((resolve, reject) => {
                    this.httping=true;
                this.$http.post('/boss/login',ajaxData)
                        .then((response) => {
