...
<template>
    <div class="followTrade_box">
        <div class="top_nav">
            <router-link :to="{path:'/analogTrading/followTrade/positioning',query:{data:dataId}}">
                <span :class="{current: (tabSwitch==tabSwitchList[0])}" >正在持仓</span>
            </router-link>

            <router-link :to="{path:'/analogTrading/followTrade/historyRecord',query:{data:dataId}}">
