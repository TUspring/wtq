    ...
    <div class="public_modal custom_modal">
        ...
        <div class="public-ec-container">
            ...
            <div class="public-ec-btn">
                ...
                <!--<span class="public" @click="public">修改</span>-->
                <Button class="cancel" @click="close">取消</Button>
                <Button class="public" @click="public" type="primary">修改
...
<script>
    export default {
        ...
        props:['message'],
        beforeMount() {
            this.projectId=this.message.id
            this.projectName=this.message.name
        ...
        methods:{
            ...
            public(){
                ...
                this.$http.put('/admin/regular_project/info/signal_account',ajaxData)
                        .then((response) => {
                            const data = response.data;
