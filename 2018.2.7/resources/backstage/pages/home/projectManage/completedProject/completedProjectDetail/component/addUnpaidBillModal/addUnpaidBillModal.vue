...
<template>
    <div class="addUnpaidBillModal">
        <div class="top_content">添加待支付账单</div>
        ...
        <div class="item_content cl">
            ...
            <div class="value_content">
                $<input type="text" placeholder="请输入待添加的待支付金额" name="待添加的待支付金额" v-model="unpaid_money"  v-validate data-vv-rules="required|decimal:2">
            </div>
        </div>
...
<script>
    export default{
        ...
        beforeMount(){
            ...
            this.total_unpaid_money = this.modalMsg.id.total_unpaid_money
        },
        methods:{
            //提交
            submit(){
