        ...
        <div class="details_content">
            <div class="content cl">
                ...
                <div class="signalSource_information cl" v-show="showSignalSource">
                    <div class="header cl">信号源信息<span  class="btnClass" @click="modifySignalSource">修改</span></div>
                ...
                <div class="signalSource_information cl" v-show="editSignalSource">
                    <div class="header cl">信号源信息<span class="btnClass" @click="saveSignalSource">保存</span></div>
                    <div class="signalSource_content cl">
                        <ul id="signal_list" class="cl">
                            <li>
                                <div class="item_title">
                ...
                <div class="riskControl_information cl" v-show="showRiskControl">
                    <div class="header cl">风控指标<span  class="btnClass" @click="modifyRiskControl">编辑</span></div>
                ...
                <div class="riskControl_information cl" v-show="editRiskControl">
                    <div class="header cl">风控指标<span class="btnClass" @click="saveRiskControl">保存</span></div>
                    <div class="risk_content cl">
                        <ul id="risk_list" class="cl">
                            <li>
                                <div class="item_title">
                            ...
                            <li>
                                ...
                                <div class="item_value">
                                    <Select v-model="type" style="width:150px;" :transfer="true">
    ...
    export default {
        ...
        methods: {
            ...
            saveSignalSource(){
                ...
                this.$http.put('admin/policy/put_standard_info',ajaxData)
                    .then((response)=>{
                        const data = response.data
                        const {retCode} = data
                        if(retCode == '0'){
