...
<template>
    <div class="customer-item">
        ...
        <div class="customer-item-content cl">
            ...
            <div class="customer-item-content-block">
                ...
                <div class="middle-content">
                    <div style="width: 80px">
                        <span class="content-title">客户量</span><br>
            ...
            <div class="customer-item-content-block">
                <span class="right-border"></span>
                <div class="middle-content" style="width: 180px">
                    <Button v-if="canChangeParent" @click="changeParentClick">更换归属</Button>
                    <Button v-else disabled>更换归属</Button>
                    <Button style="margin-left: 5px" @click="changeLevelClick" v-if="customer.is_up=='1'">提升等级</Button>
                    <Button style="margin-left: 5px" disabled v-else>升级等级</Button>
                </div>
            </div>
        </div>
        ...
        <div class="customer-item-child">
            <customerItem v-if="index<showCount" v-for="(value,index) in customer.sons" :key="value.id" :customer="value" :loadingChild="loadingChild" @stickCustome="stickCustome" @changeLoadingChildStatus="changeLoadingChildStatus" @changeLevel="changeLevel" @changeParent="changeParent"></customerItem>
        </div>
...
<script>
    export default {
        ...
        props: ['customer','loadingChild','isTopCurstomer'],
        methods:{
            addShowCount(){
            ...
            changeParentClick(data){
                var customer=this.customer
                this.changeParent(customer.users)
            },
            changeParent(data){
                this.$emit('changeParent',data)
            },
            changeLevelClick(data){
                var customer=this.customer
                this.changeLevel(customer.users)
            },
            changeLevel(data){
