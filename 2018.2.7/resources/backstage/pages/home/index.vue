<style scoped lang="less">
   #app_content .layout-content-main{
...
<template>
    ...
    <Modal v-model="compontentStatus.changePWDModal.show" width="630" class-name="ivu-modal-custom ivu-modal-middle"
            ...
            <div slot="header"></div>
            <div slot="close"></div>
            <v-changePWDModal v-if="compontentStatus.changePWDModal.show"
                              @close="closeChangePWDModal"></v-changePWDModal>
            <div slot="footer"></div>
        </Modal>
        <v-header></v-header>
        <div class="layout" v-if="user.id">
            <div class="layout-content">
                <Row>
                    ...
                    <Menu id="leftNavUl" ref="leftNav" :active-name="leftNav.activeName" width="auto"
                          :open-names="leftNav.openName">
